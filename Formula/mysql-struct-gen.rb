class MysqlStructGen < Formula
  ...
  version "1.0.4" # Auto-updated by GitHub Actions
  license "MIT"

  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/yuksbg/mysql-struct-gen/releases/download/v1.0.4/mysql-struct-gen-darwin-amd64.tar.gz"
      sha256 "3e637d588e75404fa09bfe359973aaf005fb22d5ac319f640785eca395e04cf9"
    elsif Hardware::CPU.arm?
      url "https://github.com/yuksbg/mysql-struct-gen/releases/download/v1.0.4/mysql-struct-gen-darwin-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/yuksbg/mysql-struct-gen/releases/download/v1.0.4/mysql-struct-gen-linux-amd64.tar.gz"
      sha256 "a38f5979473a9e7498f747f830e7542d74699eeb30e01d3cee5f2cb28bbbb13a"
    elsif Hardware::CPU.arm?
      url "https://github.com/yuksbg/mysql-struct-gen/releases/download/v1.0.4/mysql-struct-gen-linux-arm64.tar.gz"
